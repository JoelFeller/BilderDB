...
class BilderController
{
    public function index()
    {
        ...
        $view->title = 'Bilder';
        $view->heading = 'Bilder';
        $view->galerie = $bilderRepository->readAll();
        $view->display();
    }
    ...
    {
        $bilderRepository = new BilderRepository();
        $bilderRepository->deleteById($_GET['id']);
    ...
    public function doUpload()
    {
        if ($_POST['submitpicture']) {
            ...
            $bilderRepository = new BilderRepository();
            $bilderRepository->create($gid, $image, $title, $description);
            $bilderRepository->imgToFolder($image);
        }
